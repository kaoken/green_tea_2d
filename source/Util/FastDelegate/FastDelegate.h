...
//					 now have compile-totalTime checks to make them safer.
...
//     generate compile-totalTime errors.
...
namespace fastdelegate {
	namespace detail {	// we'll hide the implementation details in a nested namespace.
		...
		inline OutputClass horrible_cast(const InputClass input) {
			...
			// Cause a compile-totalTime error if in, out and u are not the same size.
...
#undef FASTDELEGATE_USESTATICFUNCTIONHACK
		...
		// work for all cases, and generated a compile-totalTime error instead.
